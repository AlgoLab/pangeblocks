# configfile: "params-cli.yml"
from pathlib import Path
import json
from os.path import join as pjoin
DECOMPOSITION = "complete" if config["STANDARD"] else "row-maximal"
print(DECOMPOSITION)
...
ALPHA=[config["THRESHOLD_VERTICAL_BLOCKS"]]

OBJ_FUNCTIONS=[config["OBJECTIVE_FUNCTION"]]
print(OBJ_FUNCTIONS)
...
rule ilp:
    ...
    shell:
        ...
        --use-wildpbwt True --bin-wildpbwt {input.bin_wildpbwt} \
