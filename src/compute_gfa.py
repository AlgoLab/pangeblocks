...
if __name__=="__main__":
    ...
    parser.add_argument("--dir-subsolutions", help="directory where suboptimal coverage are saved", dest="dir_subsolutions")
    parser.add_argument("--path-vert-blocks", help="json file with vertical blocks", dest="path_vert_blocks", type=str)
    parser.add_argument("--log-level", default='ERROR', dest='log_level',
